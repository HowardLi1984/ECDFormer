...
from figs.molecule_visual.ecd_mol_visual import visual_real_drugs
...
# from models.GNN_PosAndHeight import GNNPosAndHeight_Model, train_GNNPosAndHeight, eval_GNNPosAndHeight, test_GNNPosAndHeight
# from models.GNN_PosEnc import GNNPosEncoder_Model, train_GNNPosEncoder, eval_GNNPosEncoder, test_GNNPosEncoder
...
def parse_args():
    ...
    parser.add_argument('--dataset_root', type=str, default="dataset", help='dataset root')
...
if __name__ == "__main__":
    ...
    # ECD_dataset = np.load('dataset/ECD/ecd_column_charity_new_smiles.npy',allow_pickle=True).tolist()
    ...
    # if args.model_name == "gnn_allthree_half":
    #     from dataloaders.HalfDataloader import HalfGetAtomBondAngleDataloader
    #     atom_bond_dataloaders, bond_angle_dataloaders, smiles_datasets = HalfGetAtomBondAngleDataloader(
    ...
    if args.MODE == 'Real':
        ...
        # # for multi_chiral_carbon predictions
        # drug_path = "cases/test_multi_chiral_carbon.csv"
        # drug_file_name = "drug_atom_info_multi.json"
        # pred_result_path = "drug_cases_multi/"

        # # single_chiral_carbon predictions
        drug_path = "cases/drug_molecules.json"
        drug_file_name, pred_result_path = "excellent_drug_info.json", "excellent_drug_cases/"
        ...
        visual_path = f'figs/{args.model_name}/'
        ...
        # visualize the prediction ECD spectra
        visual_real_drugs(
            root_path="/remote-home/lihao/ai4s/ECDFormer/open_source/figs/gnn_allthree/",
            json_path=drug_file_name, img_save_path=pred_result_path,
        )
